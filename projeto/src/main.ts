...
const musicasGeradas = async () => {
  try {
    const response = await fetch(
      "https://api.deezer.com/chart/0/tracks?limit=100&country=ES"
    );
...
const musicasPesauqisads = document.querySelector(
  ".fa-magnifying-glass"
) as HTMLElement;
...
const botaoVoltarParaNaoRepetir = document.querySelector(
  ".fa-repeat-1"
) as HTMLElement;
